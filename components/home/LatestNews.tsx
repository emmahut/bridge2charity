        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {latest.map((article, index) => (
            <Link
              ...
              className="group flex flex-col overflow-hidden rounded-lg border border-navy/5 bg-white shadow-soft-sm transition-all duration-300 hover:-translate-y-1 hover:border-orange/20 hover:shadow-xl hover:shadow-navy/5"
            >
            {/* Cover image */}
