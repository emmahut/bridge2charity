        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {featuredArticle && (
            <Link
              ...
              className="group grid overflow-hidden rounded-lg border border-navy/8 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-orange/25 hover:shadow-xl hover:shadow-navy/10 lg:grid-cols-[1.08fr_0.92fr]"
            >
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
            {otherArticles.map((article) => (
              <Link
                ...
                className="group flex flex-col overflow-hidden rounded-lg border border-navy/8 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-orange/25 hover:shadow-xl hover:shadow-navy/10 sm:flex-row"
              >
